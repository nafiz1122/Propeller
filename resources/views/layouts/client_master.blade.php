...
<head>
	...
	<link rel="stylesheet" href="/client_assets/css/slicknav.css">
    <link rel="stylesheet" href="/client_assets/css/flaticon.css">
    <link rel="stylesheet" href="/client_assets/css/progressbar_barfiller.css">
    <link rel="stylesheet" href="/client_assets/css/gijgo.css">
    <link rel="stylesheet" href="/client_assets/css/animate.min.css">
    <link rel="stylesheet" href="/client_assets/css/animated-headline.css">
	...
	<link rel="stylesheet" href="/client_assets/css/themify-icons.css">
...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="/client_assets/img/logo/loder.png" alt="">
                </div>
            </div>
        </div>
    </div> --}}
    ...
    <!-- header end -->
        ...
        <!--end content-->
    <footer>
        <div class="footer-wrapper section-bg2" data-background="/client_assets/img/gallery/footer_bg.png">
            <!-- Footer Top-->
                            ...
                            <div class="single-footer-caption mb-30">
                                <div class="footer-tittle">
                                    <div class="footer-logo mb-20">
                                        <a href="index.html"><img src="/client_assets/img/logo/logo2_footer.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div id="mc_embed_signup">
                                        ...
                                        method="get" class="subscribe_form relative mail_part">
                                            ...
                                            <div class="form-icon">
                                                ...
                                                class="email_icon newsletter-submit button-contactForm"><img src="/client_assets/img/gallery/form.png" alt=""></button>
                                            </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- Jquery Mobile Menu -->
    <script src="/client_assets/js/jquery.slicknav.min.js"></script>
    ...
    <script src="/client_assets/js/animated.headline.js"></script>
    <script src="/client_assets/js/jquery.magnific-popup.js"></script>

    <!-- Date Picker -->
    <script src="/client_assets/js/gijgo.min.js"></script>
    <!-- Nice-select, sticky -->
    <script src="/client_assets/js/jquery.nice-select.min.js"></script>
    <script src="/client_assets/js/jquery.sticky.js"></script>
    <!-- Progress -->
    <script src="/client_assets/js/jquery.barfiller.js"></script>
    
    <!-- counter , waypoint,Hover Direction -->
    <script src="/client_assets/js/jquery.counterup.min.js"></script>
    <script src="/client_assets/js/waypoints.min.js"></script>
    <script src="/client_assets/js/jquery.countdown.min.js"></script>
    <script src="/client_assets/js/hover-direction-snake.min.js"></script>

    <!-- contact js -->
    <script src="/client_assets/js/contact.js"></script>
    <script src="/client_assets/js/jquery.form.js"></script>
    <script src="/client_assets/js/jquery.validate.min.js"></script>
    <script src="/client_assets/js/mail-script.js"></script>
    <script src="/client_assets/js/jquery.ajaxchimp.min.js"></script>
